<div class="row">
    <legend>ALISTAMIENTO <e id="lbCli"></e><e id="lbSuc"></e></legend>
    <div class="col-12">
        <form id="formCliSuc">
    ...
    <div class="col-lg-3">
        <div class="card border-warning mb-3 enlace est_env_als" id="card-piking" estals="1" style="max-width: 20rem; border: 3px solid rgba(0, 0, 0, 0.125); border-radius: 0.3rem;">
            <div class="card-header bg-warning"><b class="text-light">PIKING</b><span class="ion-social-dropbox text-light float-right" style="font-size: x-large"></span></div>
            <div class="card-body alert-warning">
                <h5 class="card-title" style="color: #ce8300;" id="cantEnvPiking"></h5>
                <p class="card-text">Envios en Piking</p>
            </div>
        </div>        
    </div>
    <div class="col-lg-3">
        <div class="card border-info mb-3 enlace est_env_als" id="cardSolucion" estals="2" style="max-width: 20rem; border: 3px solid rgba(0, 0, 0, 0.125); border-radius: 0.3rem;">            
            <div class="card-header bg-info"><b class="text-light">PAKING</b><span class="ion-cube text-light float-right" style="font-size: x-large"></span></div>
            <div class="card-body alert-info">                
                <h5 class="card-title" style="color: #2c77ff;" id="cantEnvPaking"></h5>
                <p class="card-text">Envios en Paking</p>
            </div>
        </div>        
    </div>
    <div class="col-lg-3">
