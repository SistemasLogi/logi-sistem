                ...
                <div class="row">
                    <div class="form-group row margen_top col-lg-4">
                        ...
                        <div class="col-10">
                            ...
                            <input class="form-control" type="text" id="inputNumOrd" name="inputNumOrd">
                            <input class="form-control" type="text" id="inputTdCli" name="inputTdCli">
                            <input class="form-control" type="text" id="inputNumDocCli" name="inputNumDocCli">
                            <input class="form-control" type="text" id="inputCiuId" name="inputCiuId">
                            <input class="form-control" type="text" id="inputTipoServ" name="inputTipoServ">
                            <input class="form-control" type="text" id="inputTipoEnv" name="inputTipoEnv">
                            <input class="form-control" type="text" id="inputNumSuc" name="inputNumSuc">
                        </div>
                    </div>
