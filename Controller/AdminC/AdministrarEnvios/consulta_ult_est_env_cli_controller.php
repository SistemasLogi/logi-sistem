...
if ($_POST) {
    ...
    if (isset($_SESSION["adminlogi"])) {
        ...
        if ($tipo_doc == '0' && $suc_id == '0') {
            ...
            echo json_encode($est_env->consulta_ultimo_est_envios("", "AND (TM.exe_ee_id != 6 AND TM.exe_ee_id != 7 AND TM.exe_ee_id != 11) AND cl.cli_td_id = " . $tipo_doc . " AND cl.cli_num_doc = " . $num_doc, ""));
        } elseif ($tipo_doc != '0' && $suc_id != '0') {
            echo json_encode($est_env->consulta_ultimo_est_envios_suc("", "AND (TM.exe_ee_id != 6 AND TM.exe_ee_id != 7 AND TM.exe_ee_id != 11) AND cl.cli_td_id = " . $tipo_doc . " AND cl.cli_num_doc = " . $num_doc, " AND oxs.suc_num_id = " . $suc_id . ""));
        }
