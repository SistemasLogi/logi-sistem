...
if (isset($_SESSION["adminlogi"])) {
    ...
    if ($_POST) {
        ...
        if ($sheetData[1]['G'] == "Nombre Destinatario" && $sheetData[1]['H'] == "Direccion Destinatario" && $sheetData[1]['I'] == "Ciudad Destino" && $sheetData[1]['J'] == "Departamento Destino") {
            ...
            for ($i = 2; $i <= count($sheetData); $i++) {
                ...
                $obj_env_vo->setCantidad($sheetData[$i]['B']);
                $obj_env_vo->setPeso_kg($sheetData[$i]['C']);
                $obj_env_vo->setAlto_cm($sheetData[$i]['D']);
                $obj_env_vo->setAncho_cm($sheetData[$i]['E']);
                $obj_env_vo->setLargo_cm($sheetData[$i]['F']);
                $obj_env_vo->setTrayecto("");
                $obj_env_vo->setNombre(str_replace("'", '\\\'', $sheetData[$i]['G']));
                $obj_env_vo->setDireccion($sheetData[$i]['H']);
                $obj_env_vo->setCiudad_dest($sheetData[$i]['I']);
                $obj_env_vo->setDepto_dest($sheetData[$i]['J']);
                $obj_env_vo->setTelefono($sheetData[$i]['K']);
                $obj_env_vo->setContenido(str_replace("'", '\\\'', $sheetData[$i]['L']));
